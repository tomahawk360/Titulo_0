...
\newcommand{\nombrealumno}{Ignacio Andrés Ortiz Valdebenito}
...
\usepackage{minted} \setminted{bgcolor=ptgray!42,fontfamily=tt, fontsize=\footnotesize,autogobble=true,linenos=true,tabsize=4,numbersep=5pt,baselinestretch=0.75,showspaces=false,vspace=0.25cm }
...
\input{30_introduccion}
\newpage
\input{40_definicion_del_problema}
\newpage
\input{50_marco_conceptual}
\newpage
\input{60_propuesta_de_solucion}
\newpage
\input{70_validacion_de_la_solucion}
\newpage
\input{80_conclusiones}
